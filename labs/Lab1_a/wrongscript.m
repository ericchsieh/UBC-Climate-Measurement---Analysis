...
%add a comment to explain it starting with your initial, e.g.:
...
%to square a vector is x.^2 instead of x^2 ****
...
%changed to correct syntax masknan=isnan(y); from masknan=~isnan(y);
masknan=~isnan(y);
...
%==========================================================================
%create a mask where z is below -200 or above 200
maskz=z>-200 | z<200;
...
subplot(1,2,2)
%plot x as a function of z with black circles
plot(x,z,'go')
